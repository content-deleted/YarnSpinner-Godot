...
namespace YarnSpinnerGodot {
    public static class NumberPlurals {
        public enum PluralCase { Zero, One, Two, Few, Many, Other, NoPluralisation }
        ...
        public static string PluralCaseString(PluralCase pluralCase) {
            return pluralCase.ToString().ToLower();
        }

        public static string PluralCaseString(int pluralCase) {
            switch(pluralCase) {
                case 0: return PluralCaseString(PluralCase.Zero);
                case 1: return PluralCaseString(PluralCase.One);
                case 2: return PluralCaseString(PluralCase.Two);
                case 3: return PluralCaseString(PluralCase.Few);
                case 4: return PluralCaseString(PluralCase.Many);
                case 5: return PluralCaseString(PluralCase.Other);
                case 6: return PluralCaseString(PluralCase.NoPluralisation);
...
*/
        ...
        public static int GetFraction(float value) {
            var e = Mathf.StepDecimals(value);
            var v = value - (int)value;
            return (int)(v * Mathf.Pow(10, e));
        }
    }
}